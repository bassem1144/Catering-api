...
$router->get('/api/facilities/search/', FacilityController::class . '@searchFacilities'); // Search for a facility by name, description, or tag
...
$router->get('/api/facilities', FacilityController::class . '@readAll'); // Read multiple facilities, their location, and their tags
